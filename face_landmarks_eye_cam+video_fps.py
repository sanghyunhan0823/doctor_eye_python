# 한상현 연구보고서용 다섯번째 코드 - 얼굴인식 프로그램이 동영상 플레이 속도에 미치는 영향 
...
while True:
    ...
    for facial_landmarks in result.multi_face_landmarks:
        for id in eyes:
            ...
            cv2.putText(img_movie, f'FPS: {int(fps)}', (20, 70), cv2.FONT_HERSHEY_PLAIN, 3, (0, 255,0), 3)
            ...
            if distance > 55: # 이 값은 임의적이며, 수정 가능함
                ...
                cv2.putText(img_movie, f'Step back, please!', (img_movie_height/2, img_movie_width/2), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255,0), 2)
